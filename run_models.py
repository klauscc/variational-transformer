...
if __name__ == '__main__':
	...
	with torch.no_grad():
		...
		pred_y, _ = model.get_reconstruction(batch_dict["tp_to_predict"],
											 batch_dict["observed_data"], batch_dict["observed_tp"],
											 mask=batch_dict["observed_mask"], n_traj_samples=3,
											 mode=batch_dict["mode"])
		torch.save({'truth': batch_dict,
					'predict': pred_y,
					}, 'experiments/my_save_' + args.z0_encoder)
